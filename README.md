...
I had the intension to explain those components :
  N-MOSFET , 7-SEGMENT , DHT22 SENSOR , HC-SR04 SONIC , SG90 SERVO , 16x2 LCD
...
Also provided the same **"static"** ohm's calculator(also in progress to make it work) 
...
I want to complete the 3 remaining components 
